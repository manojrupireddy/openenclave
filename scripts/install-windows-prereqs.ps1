...
Param(
    ...
    [string]$AzureDCAPNupkgURL = 'https://www.nuget.org/api/v2/package/Microsoft.Azure.DCAP/1.9.0',
    [string]$AzureDCAPNupkgHash = 'B02B398DF16153CC327A494BFD0FBCA44CC97431BF7623EB5E6A4C949E9ABEEF',
